...
public class Taller_No_3 {
    ...
    public static void main(String[] args) {
        ...
        do {    // comienzo del ciclo
            ...
            switch (op) {
                case "1":// inserta estudiantes
                    ...
                    String y = (JOptionPane.showInputDialog("Digite Nombre"));

                    // Define variable cadena z la cual se agrega en un cuadro de dialogo
                    String z = (JOptionPane.showInputDialog("Digite Primer Apellido"));

                    // Se añaden los datos registrados a la cadena en su respectivo orden x,y y z
                    String aa = (JOptionPane.showInputDialog("Digite Segundo apellido"));
                ...
                case "2":// elimina estudiantes

                    // Llama a eliminar posicion el cual con el codigo busca y elimina
                    lista.eliminarPosicion(lista.obtenerPosXcod(Integer.parseInt(
                            JOptionPane.showInputDialog("Digite el codigo del estudiante que desea eliminar"))));    /*
                     * llama al metodo para eliminar posicion3
                     */
                ...
                case "3":
                    ...
                    int codigo = Integer.parseInt(
                            ...
                            "Digite el codigo del Estudiante a modificar"));
                    ...
                    if (nodo != null) {
                        ...
                        int cod = Integer.parseInt(JOptionPane.showInputDialog("Digite Codigo de Estudiante", nodo.dato));

                        // Se añaden los datos registrados a la cadena en su respectivo orden x,y y z
                        String nombre = (JOptionPane.showInputDialog("Digite Nombre", nodo.dato2));
                        
                        // Define variable cadena y la cual se agrega en un cuadro de dialogo
                        String apellido = (JOptionPane.showInputDialog("Digite Primer Apellido", nodo.dato3));
                ...
                case "4":
                    ...
                    String opcion = JOptionPane.showInputDialog("Ordenar estudiantes por:\n1) Codigo\n2)Apellido");
        ...
        System.exit(0);    /*
         * sale del sistema al ejecutar el main
         */
    }    /*
    ...
    public void eliminarFinal() {
        Nodo ant = cabeza;              /*
         * El nodo anterior es igual a cabeza
         */
        Nodo aux = cabeza.siguiente;    /*
         * el auxiliar ahora es uno mas adelante
         */
        ...
        while (aux.siguiente != null) {    /*
             * Ciclo hasta siguiente ser null
             */
            ant = ant.siguiente;           /*
             * el anterior es el anterior con el siguiente
             */
            aux = aux.siguiente;           /*
             * Asi se mueve al siguiente nodo
             */
        }

        ant.siguiente = null;    /*
         * se le pone que al terminar el ciclo
         */
     ...
     */
    public void eliminarPosicion(int x) {    /*
         * dise que insertaremos x
         */
         ...
         */
        if (x == 1) {                                 /*
             * si x es igual a 1 entonces
             */
            eliminarPrimero();                        /*
             * llame al metodo eliminar primero
             */
        } else {
            if (x == 8) {                             /*
                 * si es igual a 8 siendo 8 el numero de nodos
                 */
                eliminarFinal();                      /*
                 * llama al metodo eliminar final
                 */
            } else {                                  /*
                 * si no entonces haga lo siguiente
                 */
                Nodo ant = cabeza;              /*
                 * decimos que anterior es igual a cabeza
                 */
                Nodo actual = cabeza.siguiente;    /*
                 * actual es el que sigue de cabeza
                 */
                Nodo siguiente = actual.siguiente;    /*
                 * y siguiente es despues de actual
                 */
                int can = 2;                   /*
                 * cantidad 2 osea empieza desde la posicion 2
                 */

                while (can != x) {                    /*
                     * ciclo hasta que cantidad sea diferente de x
                     */
                    can++;                            /*
                     * cantidad aumenta de 1 en uno
                     */
                    ant = ant.siguiente;              /*
                     * cuando eso entonces se movera asi
                     */
                     ...
                     * actual sera el que sigue
                     */
                    siguiente = siguiente.siguiente;    /*
                     * siguiente sera el que sigue
                     */
                }                                       /*
                 * cuando se termine anterior
                 */

                ant.siguiente = siguiente;              /*
                 * anterior.siguiente sera siguiente
                 */

                /*
                 * osea se salta uno y lo borra y ese sera el numero que el
                 * damos
                 */
            }
        }
    ...
    public int cantidadNodos() {
         ...
         * cantidad lo que hace es contar el numero de veces que auxiliar se
         * mueve
         */
    ...
    public String buscarNodo(int n) {    /*
         * le vamos a pasar en main el valor n
         */
        int can = 1;         /*
         * Iniciamos con la cantidad igual a 1
         */
        Nodo aux = cabeza;    /*
         * Decimos que auxiliar esta desde la posicion 1
         */
        String encontrado = null;

        while (aux.dato != 0) {     /*
             * Ciclo hasta que el dato de auxiliar sera diferente de n
             */
            can++;                  /*
             * Cantidad se aumenta de 1 en 1 contando la posicion de auxiliar
             */
            ...
            aux = aux.siguiente;    /*
             * Auxiliar sera siguiente en siguiente
             */
        }

        return encontrado;    /*
         * retorna el valor de cantidad osea donde esta el dato buscado
         */
    }
...
//  inicia la parte de ordenar    
    ...
    public void ordenar(int v[], int in) /*
     * int [] v, int cant
     */ {
        if (in < v.length) {
            int men = v[in];
