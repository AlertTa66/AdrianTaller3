...
public class EntidadBancariaGui extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jTextField1.setName("tfCuenta");

        jTextField2.setName("tfFecha");

        jTextField3.setName("tfMonto");
        ...
        jComboBox1.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "Consignación", "Retiro" }));
        jComboBox1.setName("ComboTransaccion");

        jComboBox2.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "Ahorro", "Corriente" }));
        jComboBox2.setName("comboCuenta");
...
//           }
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            ...
            public void run() {
                new EntidadBancariaGui().setVisible(true);
            }
        });
